...
from src.ml.train_genre_model import train_and_evaluate_model as train_genre_model
...
class ModelTrainingPipeline:
    ...
    def run(self) -> bool:
        ...
        training_tasks = [
            ...
            },
            {
                ...
                "function": lambda: train_popularity_regression_model(
    ...
    def _print_summary(
        self, success_count: int, failure_count: int, total_duration: float
    ):
        ...
        print(
            f"⏱️  Total duration: {total_duration:.2f} seconds ({total_duration/60:.2f} minutes)"
        )
        print()
