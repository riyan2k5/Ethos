...
def load_trained_model():
    ...
    model_path = Path(__file__).parent.parent.parent / "models" / "genre_classification_model.pkl"
...
class TestDataIntegrity:
    ...
    def test_train_test_validation(self, prepare_datasets):
        ...
        critical_failures = [
            check for check in result.results
...
class TestMLPipelineIntegration:
    ...
    def test_full_ml_pipeline_validation(self, prepare_datasets, load_trained_model):
        ...
        print("\n1. Data Integrity:", "✅ PASSED" if integrity_result.passed else "❌ FAILED")
