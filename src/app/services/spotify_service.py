...
from src.app.services.cache import cover_art_cache
                ...
                async with session.get(
                    ...
                    if response.status == 200:
                        ...
                        if self.access_token:
                            ...
                            async with aiohttp.ClientSession(
                                connector=retry_connector, timeout=retry_timeout
                            ) as retry_session:
                                async with retry_session.get(
                                    ...
                                    if retry_response.status == 200:
                                        ...
                                        retry_images = retry_data.get("album", {}).get(
                                            "images", []
                                        )
                                        if retry_images:
