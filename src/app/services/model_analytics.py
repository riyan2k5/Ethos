...
class ModelAnalytics:
        ...
        if features_file.exists():
            try:
                with open(features_file, "rb") as f:
                    ...
                    info["features"] = (
                        features[:10] if isinstance(features, list) else []
                    )
            except:
    ...
    def get_clustering_model_info(self) -> Dict:
        ...
        info = {
            ...
            "model_file": self.get_file_size(model_file),
            "scaler_file": (
                self.get_file_size(scaler_file) if scaler_file.exists() else "N/A"
            ),
            "model_date": self.get_file_date(model_file),
            "exists": model_file.exists(),
        }
    ...
    def get_all_analytics(self) -> Dict:
        ...
        return {
            ...
            "dataset_info": {"current_dataset_size": self._get_current_dataset_size()},
        }
