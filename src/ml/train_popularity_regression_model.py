...
# Core audio features used for regression (excluding popularity as it's the target)
CORE_FEATURES = [
    "danceability",
    "energy",
    "loudness",
...
def train_popularity_regression_model(table_name: str, target_col: str):
    """
    Trains a Random Forest Regressor to predict popularity levels.
    ...
    try:
        ...
        print(f"To use this model, load it and call predict_popularity(features)")
