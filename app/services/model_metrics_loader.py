...
from sklearn.metrics import accuracy_score, classification_report, mean_squared_error, mean_absolute_error, r2_score, silhouette_score
...
class ModelMetricsLoader:
    ...
    def get_similar_songs_metrics(self) -> Dict:
        ...
        return {
            "note": "KNN similarity model - metrics not applicable"
        }
